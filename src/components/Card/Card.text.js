...
test('Butonlara tıklanınca fonksiyonlar doğru parametrelerle çağrılır', async () => {
  ...
  // prop olarak scoops bileşenin gönderilen orjinal fonksiyonları gönderemeyeceğimizden fonksiyonlar doğru şekilde doğru zamanda doğru parametreler çalışıyor mu kontrolünü yapabilmek için asil fonksiyonların yerine test fonksiyonları göndereceğiz.
  //mock funtions takit fonksiyonlar,gerçekten state günellemez,çağıırldı mı kaç kez çağırıldı test eder.
